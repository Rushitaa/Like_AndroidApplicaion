...
public class GeofencingActivity extends ActionBarActivity implements ConnectionCallbacks, OnConnectionFailedListener {
...
//        startActivity(i);
    ...
    class AddressResultReceiver extends ResultReceiver {
        ...
        protected void onReceiveResult(int resultCode, Bundle resultData) {
            ...
            Intent i = new Intent(GeofencingActivity.this, Mylikes.class);
            i.putExtra("username_id", pos);
            i.putExtra("location_id",mAddressOutput);
            finish();
//            Toast.makeText(getApplicationContext(), mAddressOutput+"Geo" , Toast.LENGTH_LONG).show();
            startActivity(i);
        ...
        query.getFirstInBackground(new GetCallback<ParseObject>() {
            public void done(ParseObject likeObject, ParseException e) {
                if (e == null) {
                    ...
                    likeObject.put("location", mAddressOutput);
     ...
     query.getFirstInBackground(new GetCallback<ParseObject>() {
         public void done(ParseObject likeObject, ParseException e) {
             if (e == null) {
                 // Now let's update it with some new data. In this case, only cheatMode and score
                 // will get sent to the Parse Cloud. playerName hasn't changed.
                 likeObject.put("Address", mAddressOutput);
                 likeObject.saveInBackground();
